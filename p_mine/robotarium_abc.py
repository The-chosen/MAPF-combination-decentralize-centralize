...
class RobotariumABC(ABC):
    ...
    def __init__(self, number_of_robots=-1, show_figure=True, sim_in_real_time=True, initial_conditions=np.array([])):
        ...
        self.boundaries = [-0.5, -0.12, 2, 1.2]
        ...
        self.robot_diameter = 0.10
        self.wheel_radius = 0.016
        self.base_length = 0.084
        self.max_linear_velocity = 0.07
        ...
        if self.initial_conditions.size == 0:
            self.poses = misc.generate_initial_conditions(self.number_of_robots, spacing=0.2, width=1.4, height=1)
